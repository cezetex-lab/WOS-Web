...
| Migrations tracked | 166 | Via `schema_migrations` (migration 219); 221–227 didaftarkan 2026-09-17 (§5.7 no.11); `008` + `229` + `230` diterapkan 2026-09-18 (`DITERAPKAN + terdaftar + checksum terverifikasi`). `231`–`233` diterapkan + terdaftar 2026-09-19. Rename sesi paralel 232–235 → 236–239 sudah terdaftar di live (236–239; nomor 232/233 dipakai file grant yang sudah ada). 2026-09-21 (SQL-11): migrasi `240` dipulihkan ke repo (restamp checksum `a3d394b7…`) + migrasi `241` diterapkan, sehingga live kini 166 baris |
