...
| TypeScript | ✅ DONE | — | 205 file TS total (157 `src` + 41 `tests` + 7 config), 0 tsc errors — `tsconfig` mencakup `src`+`tests`+`*.config.ts`, `allowJs: false` |
