-- ============================================================
-- 060: Worker view RPCs — submit_idea, get_worker_badges, get_worker_referrals (FIXED)
-- FIX: hr_badges → badges, hr_certifications → certifications, hr_referrals → referrals, referrant_nrp → referrer_nrp
-- ============================================================
...
-- FIX: hr_badges → badges, awarded_at → awarded_date
...
-- FIX: hr_certifications → certifications
...
-- FIX: hr_referrals → referrals, referrant_nrp → referrer_nrp
...
DO $$ BEGIN
  RAISE NOTICE 'Worker view RPCs fixed: submit_idea, get_worker_badges, get_worker_certifications, get_worker_referrals';
END $$;