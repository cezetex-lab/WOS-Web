...
const ADMIN_TILES: Record<string, QuickTileItem[]> = {
  ...
  admin_mining: [
    ...
    { icon: '📋', label: 'SIMPER', color: 'amber', path: '/admin/mining/simper' },
    { icon: '🚜', label: 'Heavy Equipment', color: 'orange', path: '/admin/mining/heavy-equip' },
    { icon: '😴', label: 'Fatigue Monitor', color: 'red', path: '/admin/mining/fatigue' },
    { icon: '📊', label: 'Produksi', color: 'green', path: '/admin/mining/production' },
    { icon: '🦺', label: 'Safety K3', color: 'teal', path: '/admin/mining/safety' },
    { icon: '📝', label: 'JSA', color: 'blue', path: '/admin/mining/jsa' },
    { icon: '⚙️', label: 'Pengaturan', color: 'slate', path: '/admin/settings' },
  ],
  admin_mill: [
    { icon: '🏭', label: 'Dashboard', color: 'cyan', path: '/admin/mill' },
    { icon: '🔥', label: 'Boiler', color: 'red', path: '/admin/mill/boiler' },
    { icon: '⚙️', label: 'Mesin Press', color: 'orange', path: '/admin/mill/machines' },
    { icon: '🔬', label: 'QC Lab', color: 'green', path: '/admin/mill/qc' },
    { icon: '📦', label: 'Packing', color: 'blue', path: '/admin/mill/packing' },
    { icon: '🔧', label: 'Maintenance', color: 'teal', path: '/admin/mill/maintenance' },
    { icon: '🚨', label: 'Breakdown', color: 'red', path: '/admin/mill/breakdown' },
    { icon: '⚙️', label: 'Pengaturan', color: 'slate', path: '/admin/settings' },
  ],
  admin_estate: [
    { icon: '🌴', label: 'Dashboard', color: 'emerald', path: '/admin/estate' },
    { icon: '🌾', label: 'Panen', color: 'green', path: '/admin/estate/harvest' },
    { icon: '🗺️', label: 'Block', color: 'teal', path: '/admin/estate/blocks' },
    { icon: '🚛', label: 'Transport TBS', color: 'blue', path: '/admin/estate/transport' },
    { icon: '🌱', label: 'Nursery', color: 'emerald', path: '/admin/estate/nursery' },
    { icon: '💧', label: 'Irigasi', color: 'cyan', path: '/admin/estate/irrigation' },
    { icon: '🏗️', label: 'Fasilitas', color: 'slate', path: '/admin/estate/facility' },
    { icon: '⚙️', label: 'Pengaturan', color: 'slate', path: '/admin/settings' },
  ],
};
