  ...
  const handleSave = async () => {
    ...
    try {
      const result = await rpcWorkerUpdateProfile({
        ...
        p_agama: form.agama,
        p_media_sosial: form.media_sosial,
        p_jenjang_pendidikan: form.jenjang_pendidikan,
        p_no_bpjs_kesehatan: form.no_bpjs_kesehatan,
        p_no_bpjs_ketenagakerjaan: form.no_bpjs_ketenagakerjaan,
        p_riwayat_penyakit: form.riwayat_penyakit,
        p_komorbid: form.komorbid,
        p_alergi: form.alergi,
        p_nama_bank: form.nama_bank,
        p_no_rekening: form.no_rekening,
        p_nama_rekening: form.nama_rekening,
        p_lokasi_penempatan: form.lokasi_penempatan,
      });
      if (isRpcError(result)) {
