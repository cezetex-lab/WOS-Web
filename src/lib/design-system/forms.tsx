...
export function Button({ children, color = 'teal', variant = 'solid', size = 'md', onClick, disabled, className = '', type = 'button', ariaLabel }: ButtonProps) {
  const colors: Record<string, string> = { teal: 'bg-teal-700 hover:bg-teal-600 text-white', blue: 'bg-blue-700 hover:bg-blue-600 text-white', red: 'bg-red-700 hover:bg-red-600 text-white', orange: 'bg-orange-700 hover:bg-orange-600 text-white', purple: 'bg-purple-700 hover:bg-purple-600 text-white', slate: 'bg-slate-600 hover:bg-slate-500 text-white', ghost: 'bg-transparent hover:bg-white/10 text-slate-300' };
